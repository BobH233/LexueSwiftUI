...
public class ImageAttributes: ObservableObject, Equatable {
    public static func == (lhs: ImageAttributes, rhs: ImageAttributes) -> Bool {
        return lhs.image == rhs.image && lhs.croppedImage == rhs.croppedImage && lhs.scale == rhs.scale
    }
