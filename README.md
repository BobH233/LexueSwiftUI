...
🔧 修改App简介（issue #1），修改病句和引起歧义的描述

🔧 修复成绩查询功能中补考查询结果异常的Bug（issue #2），同一门考试若补考则取最高分作为最终的计算依据

🔧 修复通过内置浏览器提交乐学作业时，拍照后返回会重复刷新导致提交失败的问题

🔧 修复本地已经删除，或者已经完成的事件依然可能在乐学事件更新的时候被覆盖
